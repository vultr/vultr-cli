...
func BareMetal(b *govultr.BareMetalServer) {
	col := columns{"ID", "IP", "TAG", "LABEL", "OS", "STATUS", "REGION", "CPU", "RAM", "DISK", "FEATURES"}
	display(col)

	display(columns{b.ID, b.MainIP, b.Tag, b.Label, b.Os, b.Status, b.Region, b.CPUCount, b.RAM, b.Disk, b.Features})
